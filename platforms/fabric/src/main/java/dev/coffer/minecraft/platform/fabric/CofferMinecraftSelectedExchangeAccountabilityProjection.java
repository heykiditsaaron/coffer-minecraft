...
final class CofferMinecraftSelectedExchangeAccountabilityProjection {
    private static final String REASON_CODE = "reasonCode";

    private final CofferMinecraftLifecycleAccountability accountability;

    CofferMinecraftSelectedExchangeAccountabilityProjection(CofferMinecraftLifecycleAccountability accountability) {
        this.accountability = Objects.requireNonNull(accountability, "accountability");
    }

    void recordAssembly(Path runDirectory, CofferMinecraftSelectedExchangeRequestAssembly.AssemblyResult assembly) {
        Objects.requireNonNull(runDirectory, "runDirectory");
        Objects.requireNonNull(assembly, "assembly");

        if (assembly instanceof CofferMinecraftSelectedExchangeRequestAssembly.AssemblyResult.Refused refused) {
